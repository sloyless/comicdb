...
<div data-module="count_bar">
  <div class="row">
    <div class="col-xs-6 col-lg-3">
      ...
      <span class="big-red">{{user.collectionCount}}</span>
    </div>
    <div class="col-xs-6 col-lg-3">
      <strong><i class="fa fa-fw fa-archive"></i> Total Series</strong>
      <span class="big-red">{{user.seriesCount}}</span>
    </div>
    <div class="col-xs-6 col-lg-3">
      <strong><i class="fa fa-fw fa-users"></i> Following</strong>
      <span class="big-red">{{user.follows.length}}</span>
    </div>
    <div class="col-xs-6 col-lg-3">
      <strong><i class="fa fa-fw fa-users"></i> Followers</strong>
      <span class="big-red">{{user.followers.length}}</span>
    </div>
    <div class="col-xs-12">
